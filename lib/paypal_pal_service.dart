...
class PaypalService {
  ...
  String clientId = 'AeTlljGALqTeaPOFRqoMUEegumbHe7eI5k8gZQiF9wb1dnVEocU35IR8xSf76mT62PmNXJ8IPXjQJCJ3';
  String secret = 'EFE5YRnFi0Ut-QNZSobX-gEmS9g7-cAUN8Z-DlidjIngCnk8inPkTgFXfAE9hJK7cM1fVbs6s0pfH3__';
  ...
  createPaypalPayment(Map<String, dynamic> transactions, String accessToken) async {
    try {
      ...
      if (response.statusCode == 201) {
        ...
        throw Exception("PayPal API call failed with status code ${response.statusCode}: ${body["message"]}");
      }
    } catch (e) {
